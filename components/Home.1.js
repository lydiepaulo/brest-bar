...
export function Home() {
    ...
    return (
        <div className="ui-primary flex max-h-screen min-h-screen flex-col overflow-hidden">
            <Navbar />
            ...
            {/* map */}
            <div className="!absolute z-0 top-[76px] left-0 right-0 h-screen w-screen bg-gray-secondary mapboxgl-map">
                <MapBrest />
            </div>
        </div>
    );
